    ...
    const handleUpdateImage = async (event: React.FormEvent) => {
        ...
        if (img) {
            ...
            try {
                ...
                await fetchUpdateVideo('labels', formData, token);
            ...
            <div className="flex-1 flex-col space-y-4 overflow-y-auto h-full bg-background-darker dark:bg-background-deep p-16">
                <div className="">
                    ...
                    <div className="w-full flex flex-row space-x-4 mt-8">
                        <form onSubmit={handleUpdateImage} className="w-1/6 h-full bg-accent dark:bg-accent-dark rounded-custom p-8 flex flex-col space-y-8">
                            <div className="flex-1 flex flex-col items-center justify-center space-y-4">
                                <span>Imagen</span>
                                {/*
                                    imgPath ?
                                        <img src={imgPath} alt={titleEs} className='w-40 h-56 rounded-md mt-2 p-1 border-solid border-2 border-border dark:border-border-dark object-cover' /> :
                        ...
                        <form onSubmit={handleUpateData} className="w-5/6 h-full bg-accent dark:bg-accent-dark rounded-custom p-8 flex flex-col space-y-8">
